  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        en: "Conclusion",
        fr: "Conclusion",
        guideEn: "The understanding of the close is confirmed; matters carried to controls selection (S2.1), the CRA (S3.1) or journal-entry testing (E3.1).",
        guideFr: "La compréhension de la clôture est confirmée ; éléments reportés vers la sélection des contrôles (S2.1), l'ECR (S3.1) ou les tests d'écritures (E3.1).",
      },
    ],
  },
];
