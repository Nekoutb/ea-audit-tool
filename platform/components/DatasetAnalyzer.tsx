...
const FIELDS: Record<SubLedgerKind, FieldDef[]> = {
  ...
  ap_open_items: [
    ...
    { key: "partyName", en: "Supplier name", fr: "Nom du fournisseur", required: true, aliases: ["nomfournisseur", "suppliername", "supplier", "fournisseur", "nom", "name", "intitule"] },
    { key: "amount", en: "Supplier balance", fr: "Solde fournisseur", required: true, aliases: ["solde", "balance", "montant", "amount"] },
  ],
  ar_open_items: [
    ...
    { key: "amount", en: "Customer balance", fr: "Solde client", required: true, aliases: ["solde", "balance", "montant", "amount"] },
  ],
  inventory_listing: [
