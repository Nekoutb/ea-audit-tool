...
const TILES: {
  ...
  { id: "lead-schedule", nameEn: "Lead Schedule", nameFr: "Feuilles maîtresses", descEn: "Index-named schedules with sub-totals and variances; extract to Excel, one tab per index", descFr: "Feuilles par indice avec sous-totaux et écarts ; extraction Excel, un onglet par indice", feeds: ["S3.2", "C2.1"], href: (id) => `/engagements/${id}/tools/lead-schedule` },
  ...
  { id: "confirmations", nameEn: "Circularisation", nameFr: "Circularisation", descEn: "Positive and negative requests, dispatch, replies and exceptions", descFr: "Demandes positives et négatives, envois, réponses et exceptions", feeds: ["E4.1", "E4.8", "C3.2"], href: (id) => `/engagements/${id}/confirmations` },
