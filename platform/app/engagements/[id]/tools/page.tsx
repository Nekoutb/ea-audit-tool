...
const TILES: {
  ...
  { id: "lead-schedule", nameEn: "Lead Schedule", nameFr: "Feuilles maîtresses", descEn: "Index-named schedules with sub-totals and variances; extract to Excel, one tab per index", descFr: "Feuilles par indice avec sous-totaux et écarts ; extraction Excel, un onglet par indice", feeds: ["D5.2", "A1"], href: (id) => `/engagements/${id}/tools/lead-schedule` },
  { id: "review-notes", nameEn: "Review Notes", nameFr: "Notes de revue", descEn: "Every note raised on the file: section, owner, state and resolution time", descFr: "Toutes les notes du dossier : section, responsable, état et délai de résolution", feeds: ["B1", "B6"], href: (id) => `/engagements/${id}/tools/review-notes` },
  { id: "forms", nameEn: "Forms", nameFr: "Formulaires", descEn: "Every standard form in the file, grouped by phase", descFr: "Tous les formulaires du dossier, par phase", feeds: ["D3.1", "B1"], href: (id) => `/engagements/${id}/tools/forms` },
