...
const ANALYZERS: {
  ...
  { id: "financial-analysis", nameEn: "Financial Analysis", nameFr: "Analyse financière", descEn: "Current, quick and cash ratios, DSO/DPO from the GL, gearing, turnover and return ratios", descFr: "Ratios de liquidité, DSO/DPO depuis le grand livre, endettement, rotation et rentabilité", feeds: ["D4.3", "D5.5"], href: (id) => `/engagements/${id}/tools/financial-analysis` },
