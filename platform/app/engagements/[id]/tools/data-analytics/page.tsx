...
const ANALYZERS: {
  ...
  { id: "trial-balance", nameEn: "Trial Balance Analyzer", nameFr: "Analyseur de balance générale", descEn: "Upload, confirm the four columns, map account classes to lead schedules, ingest", descFr: "Importer, confirmer les quatre colonnes, rattacher les classes aux feuilles maîtresses, ingérer", feeds: ["P6.1", "P6.2", "S3.2"], href: (id) => `/engagements/${id}/data` },
  { id: "gl-analyzer", nameEn: "General Ledger Analyzer", nameFr: "Analyseur du grand livre", descEn: "Journal-entry population for the fraud procedures and close-process work", descFr: "Population d'écritures pour les procédures de fraude et l'arrêté", feeds: ["E2.1", "S1.4"], href: (id) => `/engagements/${id}/analyzers/journal_entries` },
  ...
  { id: "financial-analysis", nameEn: "Financial Analysis", nameFr: "Analyse financière", descEn: "Current, quick and cash ratios, DSO/DPO from the GL, gearing, turnover and return ratios", descFr: "Ratios de liquidité, DSO/DPO depuis le grand livre, endettement, rotation et rentabilité", feeds: ["P3.2", "S3.3"], href: (id) => `/engagements/${id}/tools/financial-analysis` },
