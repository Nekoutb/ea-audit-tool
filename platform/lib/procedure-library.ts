...
// Covered cycles: R (E100) · B (E170) · P (E110) · I (E130) · F (E140).
...
export const PROCEDURE_LIBRARY: ProcedureLibraryEntry[] = [
  // ---- Annex A · Revenue & receivables (R → E100) ----
  E("R.110", ["E100"], "baseline", ["E", "C", "AVA"],
  ...
  E("R.120", ["E100"], "baseline", ["E", "RO", "AVA", "C"],
  ...
  E("R.150", ["E100"], "heightened", ["AVA", "CO", "P"],
  ...
  E("R.160", ["E100"], "heightened", ["E", "C", "CL"],
  ...
  E("R.170", ["E100"], "significant", ["O", "CO", "A"],
  ...
  // ---- Annex B · Cash & borrowings (B → E170) ----
  E("B.110", ["E170"], "baseline", ["E", "C", "RO", "AVA", "P"],
  ...
  E("B.140", ["E170"], "baseline", ["C", "AVA", "CL", "P", "RO"],
  ...
  // ---- Annex C · Purchases & payables (P → E110) ----
  E("P.110", ["E110"], "baseline", ["E", "C", "AVA"],
  ...
  E("P.120", ["E110"], "baseline", ["C", "AVA", "CO"],
  ...
  E("P.140", ["E110"], "heightened", ["E", "C", "AVA", "RO"],
  ...
  E("P.150", ["E110"], "heightened", ["CL", "O", "C"],
  ...
  // ---- Annex D · Inventory (I → E130) ----
  E("I.110", ["E130"], "baseline", ["E", "C", "AVA", "RO"],
  ...
  E("I.140", ["E130"], "baseline", ["E", "C", "AVA", "CO"],
  ...
  // ---- Annex E · Fixed assets & intangibles (F → E140) ----
  E("F.110", ["E140"], "baseline", ["E", "C", "AVA", "P"],
  ...
  E("F.120", ["E140"], "baseline", ["E", "RO", "AVA", "O", "CL"],
  ...
  E("F.150", ["E140"], "heightened", ["C", "CL", "P"],
