  ...
  sections: [
    {
      ...
      procs: [
        ...
        { key: "apps", en: "For each SCOT, identify the applications and interfaces through which transactions are initiated, recorded, processed and reported.", fr: "Pour chaque SCOT, identifier les applications et interfaces d'initiation, d'enregistrement, de traitement et de restitution.", srcEn: "IT inquiry (P4.3) · system landscape diagram", srcFr: "Entretiens IT (P4.3) · cartographie des systèmes" },
        { key: "accounts", en: "Map each SCOT to the significant accounts it affects, and verify every significant account is reached by at least one SCOT or scoped as a non-transactional balance.", fr: "Relier chaque SCOT aux comptes significatifs concernés et vérifier que chaque compte significatif est couvert.", srcEn: "P6.2 matrix", srcFr: "Matrice P6.2" },
        { key: "itscope", en: "Confirm the applications listed here are inside the ITGC scope (E1.1), or record why not.", fr: "Vérifier que les applications recensées entrent dans le périmètre ITGC (E1.1), ou consigner pourquoi non.", srcEn: "E1.1 scope note", srcFr: "Note de périmètre E1.1" },
      ],
    },
    {
      kind: "yn",
  ...
  sections: [
    {
      ...
      procs: [
        ...
        { key: "trace", en: "Trace it end-to-end through documents and systems, recording each step against the S1.2 flow.", fr: "La suivre de bout en bout à travers documents et systèmes, en rapprochant chaque étape du flux S1.2.", srcEn: "Source documents · system records", srcFr: "Pièces d'origine · enregistrements systèmes" },
        ...
        { key: "update", en: "Record every difference from the documented flow and update S1.2, S3.1 and S2.1 accordingly.", fr: "Consigner tout écart avec le flux documenté et mettre à jour S1.2, S3.1 et S2.1.", srcEn: "This paper", srcFr: "Ce papier" },
      ],
    },
    {
      kind: "yn",
  ...
  sections: [
    {
      ...
      procs: [
        ...
        { key: "evaluate", en: "Evaluate the design of the controls over the close and decide the response: controls testing (S2.1) and/or the journal-entry testing in E2.1.", fr: "Évaluer la conception des contrôles de l'arrêté et arrêter la réponse : tests de contrôles (S2.1) et/ou tests d'écritures (E2.1).", srcEn: "This paper · S2.1 · E2.1", srcFr: "Ce papier · S2.1 · E2.1" },
      ],
    },
    {
      kind: "yn",
      ...
      items: [
        ...
        { key: "override", en: "The management-override points in the close are identified and linked to E2.1.", fr: "Les points de contournement possibles à l'arrêté sont identifiés et reliés à E2.1." },
  ...
  sections: [
    {
      ...
      procs: [
        ...
        { key: "select", en: "Where reliance is planned, select the controls to test, naming the what-could-go-wrongs each addresses.", fr: "En cas d'appui prévu, sélectionner les contrôles à tester en précisant les WCGW couverts.", srcEn: "S1.2 control inventory", srcFr: "Inventaire des contrôles S1.2" },
        { key: "itgc_dep", en: "For each automated or IT-dependent control selected, confirm its application is covered by the ITGC scope (E1.1).", fr: "Pour chaque contrôle automatisé ou dépendant IT sélectionné, vérifier la couverture ITGC de son application (E1.1).", srcEn: "E1.1 scope", srcFr: "Périmètre E1.1" },
...
const D8_6: PaperDef = {
  ...
  reqFr: [
    ...
    "L'étendue suit la fréquence : contrôle pluriquotidien testé par sondage, contrôles mensuels/trimestriels/annuels testés sur les occurrences de la période, contrôle automatisé testé une fois par configuration si les ITGC sont efficaces. Le calendrier détermine la part de période couverte maintenant et ce que la mise à jour post-intérim (E1.3) devra ajouter.",
  ],
  ...
  sections: [
    {
      ...
      titleFr: "Partie A — Procédures et sources attendues",
      procs: [
        { key: "attribute", en: "Define, per control, the attribute evidencing operation and the documents or records where it lives.", fr: "Définir, par contrôle, l'attribut probant et les documents ou enregistrements où il se trouve.", srcEn: "S1.2 control descriptions", srcFr: "Descriptions S1.2" },
        ...
        { key: "timing", en: "Set the timing: period covered by the interim test and the roll-forward the post-interim update (E1.3) will need.", fr: "Fixer le calendrier : période couverte à l'intérim et complément attendu de la mise à jour post-intérim (E1.3).", srcEn: "Engagement timetable", srcFr: "Calendrier de la mission" },
        { key: "assign", en: "Assign each designed test to a team member and link it to the execution program that will record the result.", fr: "Affecter chaque test conçu à un membre de l'équipe et le relier au programme d'exécution qui recevra le résultat.", srcEn: "Team plan (P2.2)", srcFr: "Plan d'équipe (P2.2)" },
      ],
    },
    {
      kind: "yn",
      ...
      items: [
        ...
        { key: "rollforward", en: "Interim timing and the post-interim update are planned together (link to E1.3).", fr: "Le calendrier d'intérim et la mise à jour post-intérim sont planifiés ensemble (lien E1.3)." },
      ],
    },
  ],
};
  ...
  sections: [
    {
      ...
      titleFr: "Partie A — Procédures et sources attendues",
      procs: [
        { key: "deviations", en: "List the control deviations found (E1.1/E1.2/E1.3 and cycle tests) and assess the effect of each on the related combined risk assessment.", fr: "Recenser les déviations de contrôles constatées (E1.1/E1.2/E1.3 et tests de cycles) et leur effet sur l'évaluation combinée concernée.", srcEn: "Controls testing papers", srcFr: "Papiers de tests de contrôles" },
