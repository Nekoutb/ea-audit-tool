  ...
  sections: [
    {
      ...
      procs: [
        ...
        { key: "je", en: "Understand journal-entry practices: who can post, approval of non-standard entries, and the population of period-end adjustments.", fr: "Comprendre la pratique des écritures : qui peut saisir, approbation des écritures non standards, population des écritures de clôture.", srcEn: "User-access listing · journal-entry reports", srcFr: "Liste des accès · journaux d'écritures", tipEn: "Get the Sage/SAARI user list and match it to the actual humans: in many entities everyone shares one login, which makes 'who can post' an easy but important finding. Then export the OD journal for the closing months — that is the population of period-end adjustments E2.1 will test — and ask who approved each non-standard entry.", tipFr: "Obtenir la liste des utilisateurs Sage/SAARI et la rapprocher des personnes réelles : dans beaucoup d'entités, tout le monde partage un seul identifiant, constat facile mais important sur « qui peut passer une écriture ». Exporter ensuite le journal des OD des mois de clôture — c'est la population des ajustements de fin d'exercice que testera E2.1 — et demander qui a approuvé chaque écriture non standard." },
  ...
  sections: [
    {
      ...
      procs: [
        ...
        { key: "timing", en: "Set the timing: period covered by the interim test and the roll-forward the post-interim update (E1.3) will need.", fr: "Fixer le calendrier : période couverte à l'intérim et complément attendu de la mise à jour post-intérim (E1.3).", srcEn: "Engagement timetable", srcFr: "Calendrier de la mission", tipEn: "Push the interim test as late as the timetable allows so the roll-forward window stays short. Write the E1.3 update into the plan today — which controls, what evidence covers the remaining months, who performs it — instead of leaving 'update at final' as a blank line the busy season will erase.", tipFr: "Placer le test intérimaire aussi tard que le calendrier le permet pour raccourcir la fenêtre de mise à jour. Inscrire la mise à jour E1.3 dans le plan dès aujourd'hui — quels contrôles, quelle preuve pour les mois restants, qui l'exécute — plutôt que de laisser une ligne vide « à compléter au final » que la période de pointe effacera." },
