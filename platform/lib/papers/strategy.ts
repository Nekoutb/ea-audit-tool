...
const D4_2: PaperDef = {
  ...
  reqEn: [
    ...
    "The understanding is obtained to identify risks, not for its own sake. Each matter recorded is either carried into the risk assessment or noted as giving rise to no risk.",
  ],
  reqFr: [
    ...
    "Cette connaissance sert à identifier des risques. Chaque élément consigné est soit repris dans l'évaluation des risques, soit noté comme n'en générant aucun.",
  ],
  conclEn: [
