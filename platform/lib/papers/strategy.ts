  ...
  sections: [
    {
      ...
      procs: [
        P("scope", "Establish the characteristics that define the scope: the financial reporting framework, the reporting entity, the locations and any component to be covered.", "Établir les caractéristiques définissant l'étendue : référentiel comptable, entité présentant les comptes, implantations et composants à couvrir.", "Engagement letter (P1.4) · statutes · prior file", "Lettre de mission (P1.4) · statuts · dossier antérieur"),
        ...
        P("resources", "Allocate the team to areas and set the time budget, weighting the areas of higher assessed risk.", "Affecter l'équipe aux différentes zones et arrêter le budget-temps, en pondérant les zones de risque évalué élevé.", "Team page · budget · P2.2", "Page Équipe · budget · P2.2"),
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("areas", "Identify the areas the engagement partner will review personally, including every significant judgement and every significant risk.", "Identifier les zones que l'associé revoira personnellement, dont chaque jugement important et chaque risque important.", "S3.1 risk register · P5.1 · S3.5", "Registre des risques S3.1 · P5.1 · S3.5"),
        P("supervision", "Set the level of supervision for each team member against their competence and the difficulty of the work assigned.", "Fixer le niveau de supervision de chaque membre au regard de sa compétence et de la difficulté des travaux confiés.", "Team page grades · P2.2", "Grades de la page Équipe · P2.2"),
        P("consult", "Identify the matters on which consultation is expected, and who will be consulted.", "Identifier les points appelant une consultation et les personnes à consulter.", "Firm consultation policy · C1.3", "Politique de consultation du cabinet · C1.3"),
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("override", "Discuss how management could override controls, and the accounting entries that would be used.", "Examiner comment la direction pourrait contourner les contrôles et les écritures qui seraient utilisées.", "ISA 240 ¶31 · E2.1", "ISA 240 ¶31 · E2.1"),
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("outsourced", "Identify the parts of the IT environment operated by a third party, and cross-refer to S4.2 for the service organisation.", "Identifier les parties de l'environnement informatique exploitées par un tiers et renvoyer à S4.2 pour l'organisme de services.", "Contracts · S4.2 · inquiry of IT", "Contrats · S4.2 · entretien informatique"),
  ...
  sections: [
    {
      ...
      introFr: PROC_INTRO_FR,
      procs: [
        P("need", "Record the matter requiring expertise, and why the engagement team cannot address it alone.", "Consigner la question requérant une expertise et la raison pour laquelle l'équipe ne peut la traiter seule.", "P2.2 · risk register S3.1", "P2.2 · registre des risques S3.1"),
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("minutes", "Read the minutes of the general meetings and of the board for commitments given, guarantees granted and disputes reported.", "Examiner les procès-verbaux d'assemblée et du conseil : engagements donnés, garanties accordées et litiges signalés.", "Minutes (E6.4) · resolutions", "Procès-verbaux (E6.4) · résolutions"),
        ...
        P("strategy", "For each item identified, record whether it is recognised, disclosed or neither, and set the evidence to be obtained in E4.15.", "Pour chaque élément identifié, consigner s'il est comptabilisé, mentionné ou ni l'un ni l'autre, et arrêter les éléments à obtenir en E4.15.", "IAS 37 / SYSCOHADA · E4.15", "IAS 37 / SYSCOHADA · E4.15"),
      ],
    },
    {
      kind: "yn",
...
const D5_4: PaperDef = {
  ...
  reqEn: [
    ...
    "Management is in a unique position to perpetrate fraud by overriding controls. That risk is present in every entity and is treated as a significant risk, whatever our assessment of management's integrity (ISA 240 ¶31). The responses are performed in E2.1.",
  ],
  reqFr: [
    ...
    "La direction est en mesure de contourner les contrôles. Ce risque existe dans toute entité et est traité comme un risque important (ISA 240 ¶31). Les réponses sont mises en œuvre en E2.1.",
  ],
  conclEn: [
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("override", "Record the risk of management override as a significant risk, and set the responses to be performed in E2.1: journal entry testing, review of estimates for bias, and evaluation of significant unusual transactions.", "Consigner le risque de contournement des contrôles comme risque important et arrêter les réponses à mettre en œuvre en E2.1 : test des écritures, revue des estimations et examen des opérations inhabituelles significatives.", "ISA 240 ¶31–33 · E2.1", "ISA 240 ¶31–33 · E2.1"),
      ],
    },
    {
      kind: "yn",
      ...
      items: [
        ...
        { key: "override", en: "Management override is recorded as a significant risk with responses planned in E2.1 (procedure 7).", fr: "Le contournement des contrôles est consigné comme risque important avec des réponses prévues en E2.1 (procédure 7)." },
      ],
    },
  ],
};
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("plan", "Set the work required at completion, including the period the assessment must cover and the evidence to obtain on any mitigating plan.", "Arrêter les travaux requis à l'achèvement, dont la période à couvrir et les éléments à obtenir sur tout plan d'atténuation.", "E6.3 · C2.2 · ISA 570 (Revised) ¶13", "E6.3 · C2.2 · ISA 570 révisée ¶13"),
      ],
    },
    {
      kind: "yn",
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("outside", "Identify the transactions outside the normal course of business, and record each as a significant risk.", "Identifier les opérations hors du cours normal des affaires et consigner chacune comme risque important.", "ISA 550 ¶18 · S3.1", "ISA 550 ¶18 · S3.1"),
        P("team", "Communicate the related party names to the engagement team so that members remain alert to them during execution.", "Communiquer les noms des parties liées à l'équipe afin qu'elle y reste attentive pendant l'exécution.", "ISA 550 ¶17 · team briefing (P5.2)", "ISA 550 ¶17 · réunion d'équipe (P5.2)"),
      ],
    },
    {
      kind: "yn",
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("controls", "Obtain the controls over the estimation process, including who reviews and approves the assumptions.", "Obtenir les contrôles du processus d'estimation, notamment qui revoit et approuve les hypothèses.", "Process narrative · approval evidence · P4.1", "Descriptif de processus · preuves d'approbation · P4.1"),
  ...
  sections: [
    {
      ...
      introFr: PROC_INTRO_FR,
      procs: [
        P("gather", "Bring together the risks identified in the earlier papers: the team discussion, the preliminary analytics, internal control, fraud, going concern, related parties and estimates.", "Rassembler les risques identifiés dans les feuilles précédentes : réunion d'équipe, analyses préliminaires, contrôle interne, fraude, continuité, parties liées et estimations.", "P5.2 · P3.2 · P4.1 · P5.1 · S3.3 · S3.4 · S3.5", "P5.2 · P3.2 · P4.1 · P5.1 · S3.3 · S3.4 · S3.5"),
        ...
        P("separate", "Assess inherent risk and control risk separately for each risk identified, and record the basis for each assessment.", "Évaluer séparément le risque inhérent et le risque lié au contrôle pour chaque risque identifié et consigner le fondement de chaque appréciation.", "ISA 315 (Revised 2019) ¶34 · P4.1 · P4.2", "ISA 315 révisée ¶34 · P4.1 · P4.2"),
        P("significant", "Determine which risks are significant risks, having regard to the inherent risk factors and where the risk sits on the spectrum of inherent risk.", "Déterminer quels risques sont des risques importants, au regard des facteurs de risque inhérent et de leur position sur le spectre.", "ISA 315 (Revised 2019) ¶32 · P5.1 · S3.4 · S3.5", "ISA 315 révisée ¶32 · P5.1 · S3.4 · S3.5"),
        P("fs_level", "Identify the risks at financial statement level and set the overall responses, including team composition, supervision, and an element of unpredictability.", "Identifier les risques au niveau des états financiers et arrêter les réponses globales : composition de l'équipe, supervision et part d'imprévisibilité.", "ISA 330 ¶5 · ISA 240 ¶29 · P4.2", "ISA 330 ¶5 · ISA 240 ¶29 · P4.2"),
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("related", "Obtain the list of related parties and the nature of the relationships and transactions with each, and carry it forward to S3.5.", "Obtenir la liste des parties liées, la nature des relations et des opérations avec chacune, et la reporter en S3.5.", "Inquiry of management · share register · board minutes · S3.5", "Entretien avec la direction · registre des titres · procès-verbaux · S3.5",
    ...
    },
    {
      ...
      items: [
        ...
        { key: "related_gc", en: "The related-party list has been carried to S3.5, and the status of management's going-concern assessment recorded for S3.3 (procedures 8, 9).", fr: "La liste des parties liées a été reportée en S3.5, et l'état de l'évaluation de la continuité d'exploitation consigné pour S3.3 (procédures 8, 9)." },
