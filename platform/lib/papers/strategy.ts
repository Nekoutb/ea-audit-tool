  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("bank", "Identify from the bank documentation the guarantees, sureties and pledges given or received.", "Identifier dans la documentation bancaire les garanties, cautions et nantissements donnés ou reçus.", "Bank confirmations · loan agreements · pledge register", "Confirmations bancaires · contrats de prêt · registre des nantissements", "Read the bank confirmation replies past the balances: banks list avals, sureties, pledges and discounted bills not yet due in the lower half, and that is where the unrecorded items live. Compare every guarantee a bank names against the off-balance-sheet commitments note in the DSF. A pledge over stock or receivables also feeds the covenant picture in S3.3.", "Lire les réponses de circularisation bancaire au-delà des soldes : les banques listent avals, cautions, nantissements et effets escomptés non échus dans la partie basse, et c'est là que se cachent les éléments non comptabilisés. Rapprocher chaque garantie citée par une banque de la note des engagements hors bilan de la DSF. Un nantissement sur stocks ou créances alimente aussi l'analyse des covenants en S3.3."),
  ...
  sections: [
    {
      ...
      procs: [
        ...
        P("expert", "Identify the estimates requiring an auditor's expert, and cross-refer to S4.1.", "Identifier les estimations requérant un expert de l'auditeur et renvoyer à S4.1.", "S4.1 · P2.2", "S4.1 · P2.2", "Flag the estimates beyond the team's competence — actuarial retirement benefits, property valuations, complex financial instruments — and open S4.1 for each with the expert's name and scope. Decide now: engaging an actuary in the OHADA market takes weeks, not days. Put the cost into the budget in P2.2 before execution starts.", "Repérer les estimations dépassant la compétence de l'équipe — indemnités de fin de carrière actuarielles, évaluations immobilières, instruments financiers complexes — et ouvrir S4.1 pour chacune avec le nom et l'étendue de la mission de l'expert. Décider maintenant : engager un actuaire sur le marché OHADA prend des semaines, pas des jours. Inscrire le coût au budget de P2.2 avant le début de l'exécution."),
      ],
    },
    {
      kind: "yn",
  ...
  sections: [
    {
      ...
      introFr: PROC_INTRO_FR,
      procs: [
        P("gather", "Bring together the risks identified in the earlier papers: the team discussion, the preliminary analytics, internal control, fraud, going concern, related parties and estimates.", "Rassembler les risques identifiés dans les feuilles précédentes : réunion d'équipe, analyses préliminaires, contrôle interne, fraude, continuité, parties liées et estimations.", "P5.2 · P3.2 · P4.1 · P5.1 · S3.3 · S3.4 · S3.5", "P5.2 · P3.2 · P4.1 · P5.1 · S3.3 · S3.4 · S3.5", "Open the risk register beside P5.2, P3.2, P4.1, P5.1 and S3.3 to S3.5 and copy each risk across with the reference of the paper it came from, so one register carries everything. Where two papers describe the same exposure — the fraud discussion and the preliminary analytics both pointing at revenue cut-off, say — merge them into one line and keep both source references. A risk with no source paper behind it was invented at this stage; go back and anchor it to the work that supports it.", "Ouvrir le registre des risques à côté de P5.2, P3.2, P4.1, P5.1 et S3.3 à S3.5 et y reporter chaque risque avec la référence du papier de travail d'origine, pour que tout tienne dans un seul registre. Quand deux papiers décrivent la même exposition — la discussion fraude et l'examen analytique préliminaire visant tous deux la séparation des exercices sur les ventes — fusionner en une seule ligne en conservant les deux références. Un risque sans papier de travail d'origine a été inventé à ce stade ; retourner l'ancrer aux travaux qui le fondent."),
