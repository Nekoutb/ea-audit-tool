...
export const TASK_GROUPS: TaskGroupDef[] = [
  ...
  // ---- Acceptance ----
  { id: "a1", code: "A1", section: "acceptance", titleEn: "Due Diligence", titleFr: "Diligences client", members: ["D3.1", "D3.4"] },
  ...
  // ---- Scope & Strategy ----
  { id: "s1", code: "S1", section: "strategy", titleEn: "Audit Strategy", titleFr: "Stratégie d'audit", members: ["D1", "D4.1", "D7.1", "D4.7", "D4.8", "D4.9"] },
  ...
  { id: "e3", code: "E3", section: "execution", titleEn: "Accounts", titleFr: "Comptes", members: ["E130", "E140", "E150", "E160", "E170"] },
  { id: "e4", code: "E4", section: "execution", titleEn: "General", titleFr: "Général", members: ["E180", "E190", "E200", "E210", "E220", "E230", "E270", "E280"] },
  { id: "e5", code: "E5", section: "execution", titleEn: "Fraud Procedures", titleFr: "Procédures fraude", members: ["E350"] },
  { id: "e6", code: "E6", section: "execution", titleEn: "Response Tasks", titleFr: "Tâches de réponse", members: ["E310", "E320", "E330", "E360", "E370", "E380", "E390"] },
  ...
  { id: "c5", code: "C5", section: "conclusion", titleEn: "Report & Governance", titleFr: "Rapport & gouvernance", members: ["B2", "C1", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8"] },
];
