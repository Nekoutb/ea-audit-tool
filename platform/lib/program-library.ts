...
export const PROGRAM_LIBRARY: Record<string, LibraryStep[]> = {
  ...
  E270: [
    S("Update the commitments & contingencies assessment received from D5.2; obtain legal letters.", "Mettre à jour l'évaluation des engagements et passifs éventuels (reçue de D5.2) ; obtenir les lettres d'avocats.", ["C", "V", "P"]),
  ],
  E280: [
    ...
    S("Monitor equity vs half of share capital (statutory workflow if below — F7).", "Suivre capitaux propres vs moitié du capital social (procédure légale si inférieur — F7).", ["V", "P"]),
  ],
  E310: [
  ...
  E390: [
    S("For each estimate in the D5.7 inventory: test method, data and assumptions (ISA 540).", "Pour chaque estimation de l'inventaire D5.7 : tester méthode, données et hypothèses (ISA 540).", ["V"]),
  ],
};
