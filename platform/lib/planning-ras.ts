...
export const SECTION_A: RasItem[] = [
  ...
  { key: "a5", en: "The audit strategy memorandum is prepared, and the planning report to those charged with governance where one is required.", fr: "Le mémorandum de stratégie d'audit est établi, ainsi que le rapport de planification aux responsables de la gouvernance le cas échéant.", codes: ["S5.1", "S5.2", "P7.1"], na: true },
  ...
  { key: "a9", en: "The initial going-concern assessment is documented (ISA 570 ¶11).", fr: "L'appréciation préliminaire de la continuité d'exploitation est documentée (ISA 570 ¶11).", codes: ["S3.3"] },
