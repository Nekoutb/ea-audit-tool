...
// "wp:D9.1", like every other working paper.
...
export const SECTION_A: RasItem[] = [
  { key: "a1", en: "The independence and ethics conclusion is complete for every member of the team, with the safeguards addressing any threat identified.", fr: "La conclusion sur l'indépendance et l'éthique est complète pour chaque membre de l'équipe, avec les sauvegardes répondant aux menaces relevées.", codes: ["D3.2"] },
  { key: "a2", en: "The client acceptance or continuance decision is documented, with its risk rating.", fr: "La décision d'acceptation ou de maintien du client est documentée, avec sa cotation du risque.", codes: ["D3.1"] },
  { key: "a3", en: "The engagement letter and terms of business are signed by management and filed.", fr: "La lettre de mission et les conditions d'intervention sont signées par la direction et classées.", codes: ["D3.5", "D3.3"] },
  { key: "a4", en: "The entity-level control assessment and the fraud considerations are documented.", fr: "L'évaluation du contrôle interne au niveau de l'entité et les considérations de fraude sont documentées.", codes: ["D4.4", "D4.5", "D5.4"] },
  { key: "a5", en: "The audit strategy memorandum is prepared, and the planning report to those charged with governance where one is required.", fr: "Le mémorandum de stratégie d'audit est établi, ainsi que le rapport de planification aux responsables de la gouvernance le cas échéant.", codes: ["D1", "D4.1", "D9.2"], na: true },
  { key: "a6", en: "The combined risk assessment is complete.", fr: "L'évaluation combinée des risques est complète.", codes: ["D7.2"] },
  { key: "a7", en: "The audit programme states the nature, timing and extent of both control and substantive procedures, responds to the combined risk assessment, and answers every significant and fraud risk raised.", fr: "Le programme d'audit précise la nature, le calendrier et l'étendue des tests de contrôles et des procédures substantives, répond à l'évaluation combinée des risques et couvre chaque risque important et de fraude relevé.", codes: ["D8.5", "D8.6"] },
  { key: "a8", en: "The engagement team assessment (Appendix 1) is complete: the team collectively has the capabilities, the competence and the time.", fr: "L'évaluation de l'équipe (annexe 1) est complète : l'équipe dispose collectivement des capacités, des compétences et du temps nécessaires.", codes: ["D6.1"] },
  { key: "a9", en: "The initial going-concern assessment is documented (ISA 570 ¶11).", fr: "L'appréciation préliminaire de la continuité d'exploitation est documentée (ISA 570 ¶11).", codes: ["D5.5"] },
  { key: "a10", en: "The significant accounts, disclosures and relevant assertions have been identified and scoped.", fr: "Les comptes significatifs, informations à fournir et assertions pertinentes ont été identifiés et le périmètre arrêté.", codes: ["D5.8", "D5.1"] },
...
export const SECTION_B: RasItem[] = [
  ...
  { key: "b2", en: "I have considered the independence and objectivity of the team and of the firm, and appropriate safeguards are in place where needed.", fr: "J'ai considéré l'indépendance et l'objectivité de l'équipe et du cabinet, et des sauvegardes appropriées sont en place si nécessaire.", codes: ["D3.2"] },
  { key: "b3", en: "I have reviewed the engagement team assessment and am satisfied the team collectively has the capabilities, competence and time to perform the engagement in accordance with professional standards and legal requirements.", fr: "J'ai revu l'évaluation de l'équipe et je suis satisfait qu'elle dispose collectivement des capacités, compétences et du temps pour réaliser la mission conformément aux normes professionnelles et aux exigences légales.", codes: ["D6.1"] },
  ...
  { key: "b9", en: "Where necessary, all relevant matters have been brought to the attention of those charged with governance.", fr: "Le cas échéant, tous les points pertinents ont été portés à la connaissance des responsables de la gouvernance.", codes: ["D9.2"], na: true },
  { key: "b10", en: "I am not aware of any fact requiring disclosure to the public prosecutor (révélation des faits délictueux) that has not been dealt with as the law requires.", fr: "Je n'ai connaissance d'aucun fait délictueux devant être révélé au procureur de la République qui n'aurait pas été traité selon la loi.", codes: ["F5"], na: true },
